                ...
                <div class="left">
                    ...
                    <div class="hospital-tip">
                        <div class="hospital-level">
                            <svg t="1725695943979" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="4298" width="16" height="16">
                                <path
                        ...
                        <div class="open-time">
                            <svg t="1725696074661" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="8423" width="16" height="16">
                                <path
