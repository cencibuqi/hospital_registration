    ...
    <div class="tip-container">
            ...
            <div class="header">
                <div class="left">
                    <div class="icon-container">
                        <svg t="1725895129740" class="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <div class="right">
                    ...
                    <svg t="1725896001899" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="9174" width="16" height="16">
                        <path
        ...
        <div class="notice-container">
            <div class="header">
                <div class="left">
                    <div class="icon-container">
                        <svg t="1725896249581" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="13154" width="24" height="24">
                            <path
        ...
        <div class="notice-container">
            <div class="header">
                <div class="left">
                    <div class="icon-container">
                        <svg t="1725896941372" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="14222" width="24" height="24">
                            <path
            ...
            <div class="content">
                <ul>
                    <li>
                        <div class="point"></div>
                        <span class="desc">中国人民解放军总医院第六医学中心(原海军总医院)呼吸内科门诊停诊公告</span>
                    </li>
                    <li>
                        <div class="point"></div>
                        <span class="desc">首都医科大学附属北京潞河医院老年医学科门诊停诊公告</span>
                    </li>
                    <li>
                        <div class="point"></div>
                        <span class="desc">中日友好医院中西医结合心内科门诊停诊公告</span>
                    </li>
                </ul>
            </div>
        </div>
