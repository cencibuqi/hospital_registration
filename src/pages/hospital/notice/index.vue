<template>
  <div class="notice-container">
    <h1>{{ hospitalDetail.hospitalInfo.hospital?.hosname }}预约挂号须知</h1>
    ...
    <div class="info">
      ...
      <div class="text">
        <div class="mb-10">按照北京市卫健委统一平台要求，预约挂号规则如下：</div>
        <ul>
      ...
      <div class="text">
        <div class="mb-10">如预约成功后患者未能按时就诊且不办理取消预约号视为爽约，同一患者在自然年内爽约规则如下：</div>
        <ul>
          <li>累计爽约3次，自3次爽约日起，90天内不允许通过114平台进行预约挂号；</li>
          <li>累计爽约6次，自6次爽约日起，180天内不允许通过114平台进行预约挂号。
          </li>
        </ul>
      </div>
    </div>
